<template>
    ...
    <div class="container mt-3">
      <div class="row">
        ...
        <div class="col-md-4">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkiIFjCOZ-mMeqxd2ryrneiHedE8G9S0AboA&usqp=CAU" alt="" class="contact-img">
        </div>
      </div>
    </div>
</template>
